...
3. [链表：一道题目考察了常见的五个操作！](./problems/0707.设计链表.md)*start here
...
8. [链表：环找到了，那入口呢？](./problems/0142.环形链表II.md)*逻辑很难
9. [链表：总结篇！](./problems/链表总结篇.md)

## 哈希表

1. [关于哈希表，你该了解这些！](./problems/哈希表理论基础.md)
2. [哈希表：可以拿数组当哈希表来用，但哈希值不要太大](./problems/0242.有效的字母异位词.md)*learn charcode at
3. [哈希表：查找常用字符](./problems/1002.查找常用字符.md)
4. [哈希表：哈希值太大了，还是得用set](./problems/0349.两个数组的交集.md)
5. [哈希表：用set来判断快乐数](./problems/0202.快乐数.md)多看set
...
6. [帮你把KMP算法学个通透](./problems/0028.实现strStr.md)不懂
8. [字符串：KMP算法还能干这个！](./problems/0459.重复的子字符串.md)没看
